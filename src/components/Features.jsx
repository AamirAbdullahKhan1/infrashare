        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-md:max-w-md mx-auto">
          <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
            <div class="p-8">
              ...
              <h3 class="text-gray-800 text-xl font-semibold mb-3">Access to Cutting-Edge Equipment</h3>
              <p class="text-gray-500 text-sm leading-relaxed">Leverage the best technology with seamless access to advanced research tools, 3D printers, and specialized lab equipment, available across partner institutes.</p>
            </div>
          </div>
          ...
          <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
            <div class="p-8">
              ...
              <h3 class="text-gray-800 text-xl font-semibold mb-3">Collaborative Research Labs</h3>
              <p class="text-gray-500 text-sm leading-relaxed">Join forces with researchers and innovators through shared lab spaces, fostering collaborative projects and breakthrough innovations.</p>
            </div>
          </div>
          ...
          <div class="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
            <div class="p-8">
              ...
              <h3 class="text-gray-800 text-xl font-semibold mb-3">Startup Incubation Centers</h3>
              <p class="text-gray-500 text-sm leading-relaxed">Turn ideas into reality with access to top-notch incubation centers, mentoring, and resources to help your startup grow.</p>
            </div>
          </div>
        </div>
      </div>
