      ...
      <div className="max-w-6xl mx-auto py-16 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-md:max-w-md mx-auto">
          <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
            <div className="p-8">
              <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" className="w-8 mb-6" viewBox="0 0 32 32">
              ...
              <h3 className="text-gray-800 text-xl font-semibold mb-3">Access to Cutting-Edge Equipment</h3>
              <p className="text-gray-500 text-sm leading-relaxed">Leverage the best technology with seamless access to advanced research tools, 3D printers, and specialized lab equipment, available across partner institutes.</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
            <div className="p-8">
              ...
              <h3 className="text-gray-800 text-xl font-semibold mb-3">Collaborative Research Labs</h3>
              <p className="text-gray-500 text-sm leading-relaxed">Join forces with researchers and innovators through shared lab spaces, fostering collaborative projects and breakthrough innovations.</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl overflow-hidden shadow-md hover:shadow-lg transition-all">
            <div className="p-8">
              ...
              <h3 className="text-gray-800 text-xl font-semibold mb-3">Startup Incubation Centers</h3>
              <p className="text-gray-500 text-sm leading-relaxed">Turn ideas into reality with access to top-notch incubation centers, mentoring, and resources to help your startup grow.</p>
            </div>
          </div>
        </div>
      </div>
