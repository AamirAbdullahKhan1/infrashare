...
const Login = () => {
  return (
    <div className="font-[sans-serif] bg-gradient-to-b from-green-500 via-emerald-500 to-teal-500">
      <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4">
        <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl w-full">
          <div>
            <h2 className="lg:text-5xl text-4xl font-dmsans font-extrabold lg:leading-[55px] text-gray-800">
          ...
          <form className="max-w-[480px] bg-slate-50 px-4 py-8 rounded-lg border-slate-300 md:ml-auto w-full">
            <h3 className="text-gray-800 text-3xl font-dmsans font-extrabold mb-8">
              Sign In
            </h3>

            <div class="space-y-4">
              <div>
                <input name="email" type="email" autocomplete="email" required class="bg-gray-100 border-2 border-gray-300 w-full text-sm text-gray-800 px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent" placeholder="Email address" />
              </div>
              <div>
                <input name="password" type="password" autocomplete="current-password" required class="bg-gray-100 border-2 border-gray-300 w-full text-sm text-gray-800 px-4 py-3.5 rounded-md outline-blue-600 focus:bg-transparent" placeholder="Password" />
              </div>
              <div class="flex flex-wrap items-center justify-between gap-4">
                ...
                <div class="text-sm">
                  <a href="jajvascript:void(0);" class="text-slate-900 hover:text-orange-400 duration-200 font-semibold">
            ...
            <div class="!mt-8">
              <button type="button" class="w-full shadow-xl py-2.5 px-4 text-sm font-semibold rounded text-gray-700 border-2 border-gray-400 bg-white hover:bg-orange-500 hover:border-orange-500 duration-300 focus:outline-none">
                Log in
              </button>
            </div>
