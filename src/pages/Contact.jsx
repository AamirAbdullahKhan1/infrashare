...
const Contact = () => {
  return (
    <div class="mt-6 mb-6 max-w-7xl max-lg:max-w-3xl mx-auto bg-[#2e0249] rounded-lg">
                ...
                <div class="bg-gray-100 p-6 rounded-lg">
                    ...
                    <form class="mt-3 space-y-4">
                        <input type='text' placeholder='Name'
                            class="w-full border-2 border-gray-400 rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]" />
                        <input type='email' placeholder='Email'
                            class="w-full border-2 border-gray-400 rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]" />
                        <input type='text' placeholder='Subject'
                            class="w-full border-2 border-gray-400 rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]" />
                        <textarea placeholder='Message' rows="6"
                            class="w-full border-2 border-gray-400 rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#a91079]"></textarea>
                        <button type='button'
